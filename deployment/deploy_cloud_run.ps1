...
try {
    ...
    gcloud run services update cultural-reference-api --project=$ProjectId --region=$Region "--update-env-vars=^@^FRONTEND_ORIGINS=http://localhost:3000,$webUrl" --quiet
